...
write.csv(cvl_lodes_final, "data/lodes_residentcommute_cville_block.csv", row.names = F)
...
write.csv(cvl_lodes_finalblkgr, "data/lodes_residentcommute_cville_blkgp.csv", row.names = F)
...
write.csv(cvl_lodes_finalTr, "data/lodes_residentcommute_cville_tract.csv", row.names = F)
...
write.csv(cvl_lodes_commutepatterns, "data/lodes_rescommutepatterns_cvlcounty.csv", row.names = F)
