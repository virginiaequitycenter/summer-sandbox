...
write.csv(cvl_jobs_blocks, "lodes_employment_cville_block.csv", row.names = F)
...
write.csv(cvl_jobs_blkgr, "lodes_employment_cville_blkgr.csv", row.names = F)
...
write.csv(cvl_jobs_tract, "lodes_employment_cville_tracts.csv", row.names = F)
