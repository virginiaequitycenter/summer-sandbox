...
# -- The average and median commuting distance for people employed in each SU in the Charlottesville region (in miles) calculated for the following groups:
...
write.csv(cvl_lodes_final2, "lodes_workerscommute_cville_block.csv", row.names = F)
...
write.csv(cvl_lodes_finalblkgr, "lodes_workerscommute_cville_blkgp.csv", row.names = F)
...
write.csv(cvl_lodes_finalTr, "lodes_workerscommute_cville_tract.csv", row.names = F)
