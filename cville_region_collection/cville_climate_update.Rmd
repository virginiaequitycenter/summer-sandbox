...
ADD TEXT to explain process map

![](images/Data Process.png)


## Newly Available Data Collections
ADD TEXT to explain table
...
datatable(table,
          filter = 'top', rownames = F, options = list(
            columnDefs = list(list(targets = c(0), width = '100px'),
                              list(targets = c(2), width = '200px'),
                              list(targets = c(3), width = '200px'),
                              list(targets = c(6), width = '150px')),
            scrollX = T,
            autoWidth = T), 
          escape = F)
```

<details><summary>Icon attribution</summary><br/>
