...
* An important limitation to note is that the loan amounts and applicant income values appear prone to entry error at the individual level--a high proportion of values seemed too high to be realistic. Therefore, the tract level summaries of these variables (average and median loan amounts and applicant income in the tract) should be interpreted with extreme caution, or perhaps, not used at all. 
