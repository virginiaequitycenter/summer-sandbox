...
# 'janitor', 'tigris', 'rcartocolor', 'rgdal', 'lodes', 'psych', 'reshape2', , 'sp'
# main data
# tract
...
Proportion of low-wage jobs (earnings $1250/month or less) in each spatial

#### By Tracts

```{r}
pal <- colorNumeric("BuPu", domain = cvl_lodes_tract$lowwage_p)
...
```{r}
pal <- colorNumeric("BuPu", domain = cvl_lodes_tract$higwage_p)
...
```{r}
pal <- colorNumeric("BuPu", domain = cvl_lodes_blkgp$higwage_p)
