...
leaflet(cvl_lodes) %>% 
  ...
  addPolygons(data = cvl_lodes,
              ...
              popup = paste0("Number of jobs: ", cvl_lodes$alljobs, 2)) %>% 
...
leaflet(cvl_lodes) %>% 
  ...
  addPolygons(data = cvl_lodes,
              ...
              popup = paste0("Prop. low-wage jobs: ", round(cvl_lodes$lowwage_p, 2))) %>% 
...
leaflet(cvl_lodes) %>% 
  ...
  addPolygons(data = cvl_lodes,
              ...
              popup = paste0("Prop. high-wage jobs: ", round(cvl_lodes$higwage_p, 2))) %>% 
...
leaflet(cvl_lodes) %>% 
  ...
  addPolygons(data = cvl_lodes,
              ...
              popup = paste0("Number of jobs: ", cvl_lodes$Bach_AdvDeg_jobs)) %>% 
