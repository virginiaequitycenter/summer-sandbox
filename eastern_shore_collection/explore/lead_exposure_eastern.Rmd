...
leadrisk <- read_csv("~/Desktop/Equity Center/summer-sandbox/eastern_shore_collection/data/leadexposure_eastern_tract.csv")
...
All of this was done at the national level first and then restricted to the Eastern Shore area, so all lead risk scores are relative to the rest of the country.
...
```{r, include = FALSE}
eastern_shapes <- readRDS("~/Desktop/Equity Center/summer-sandbox/eastern_shore_collection/data/eastshore_tracts.RDS")
leadrisk <- merge(eastern_shapes, leadrisk, by = 'GEOID', all.x = TRUE)
