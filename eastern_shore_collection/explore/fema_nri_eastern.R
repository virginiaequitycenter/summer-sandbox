...
eastern_tracts <- tracts(state = "51", county = easternfips)
saveRDS(eastern_tracts, file = "data/eastern_tracts.RDS")

eastern_nri <- eastern_tracts %>% 
  left_join(nri, by = c("TRACTCE" = "TRACT"))

eastern_nri <- st_transform(eastern_nri, crs = 4326) # to WGS84, given error
...
leaflet() %>% 
  ...
  addPolygons(data = eastern_nri,
              ...
              popup = paste0("Tract Number: ", eastern_nri$NAME, "<br>",
                             "Ann. Freq.: ", round(eastern_nri$CFLD_AFREQ, 1))
  ) %>% 
...
leaflet() %>% 
  ...
  addPolygons(data = eastern_nri,
              ...
              popup = paste0("Tract Number: ", eastern_nri$NAME, "<br>",
                             "Ann. Freq.: ", round(eastern_nri$DRGT_AFREQ, 1))
  ) %>% 
...
leaflet() %>% 
  ...
  addPolygons(data = eastern_nri,
              ...
              popup = paste0("Tract Number: ", eastern_nri$NAME, "<br>",
                             "Ann. Freq.: ", round(eastern_nri$HWAV_AFREQ, 1))
  ) %>% 
...
leaflet() %>% 
  ...
  addPolygons(data = eastern_nri,
              ...
              popup = paste0("Tract Number: ", eastern_nri$NAME, "<br>",
                             "Ann. Freq.: ", round(eastern_nri$HRCN_AFREQ, 1))
  ) %>% 
...
leaflet() %>% 
  ...
  addPolygons(data = eastern_nri,
              ...
              popup = paste0("Tract Number: ", eastern_nri$NAME, "<br>",
                             "Ann. Freq.: ", round(eastern_nri$RFLD_AFREQ, 1))
  ) %>% 
...
leaflet() %>% 
  ...
  addPolygons(data = eastern_nri,
              ...
              popup = paste0("Tract Number: ", eastern_nri$NAME, "<br>",
                             "Ann. Freq.: ", round(eastern_nri$SWND_AFREQ, 1))
  ) %>% 
