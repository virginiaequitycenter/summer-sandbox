...
eastern_area <- airquality %>% 
  filter(STATEFP00=="51" & COUNTYFP00 %in% localfips)

# Export to CSV ----
write_csv(eastern_area, "eastern_shore_collection/data//airquality_eastern_tract.csv", row.names = F)
