...
write.csv(east_jobs_blocks, "lodes_employment_eastern_block.csv", row.names = F)
...
write.csv(east_jobs_blkgr, "lodes_employment_eastern_blkgr.csv", row.names = F)
...
write.csv(east_jobs_tracts, "lodes_employment_eastern_tract.csv", row.names = F)
