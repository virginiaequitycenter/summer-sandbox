...
# Regional Resident Commute Data
# Author: Lee LeBoeuf
...
write.csv(east_lodes_final, "data/lodes_residentcommute_eastern_block.csv", row.names = F)
...
write.csv(east_lodes_finalblkgr, "data/lodes_residentcommute_eastern_blkgp.csv", row.names = F)
...
write.csv(east_lodes_finalTr, "data/lodes_residentcommute_eastern_tract.csv", row.names = F)
...
write.csv(east_lodes_commutepatterns, "data/lodes_rescommutepatterns_eastern_county.csv", row.names = F)
