...
write.csv(east_lodes_final2, "lodes_workerscommute_east_block.csv", row.names = F)
...
write.csv(east_lodes_finalblkgr, "lodes_workerscommute_east_blkgp.csv", row.names = F)
...
write.csv(east_lodes_finalTr, "lodes_workerscommute_east_tract.csv", row.names = F)
...
write.csv(eastworkers_lodes_commutepatterns, "lodes_workerscommutepatterns_eastcounty.csv", row.names = F)
