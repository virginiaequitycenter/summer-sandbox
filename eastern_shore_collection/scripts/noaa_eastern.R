...
# Save to csv
write_csv(cville_noaa, file = "noaa_cville_county.csv")
write_csv(eastern_noaa, file = "noaa_eastern_county.csv")
write_csv(cville_noaa1, file = "noaa_cville_countyt.csv")
write_csv(eastern_noaa1, file = "noaa_eastern_countyt.csv")
