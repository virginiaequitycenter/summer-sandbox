...
It seems like an open question as to what exactly we do in these cases: As far as I can tell, the VCU group has not done anything to address or identify the extent of this issue in the cleaning and analysis they've done so far.
...
pattern <- paste0('(?i)', paste0(c('(\\bacadem(y|ics?)\\b)',
                                   ...
                                   '(\\beater(y|ies)\\b)',
                                   '(\\be(lectricians?|nterprises?|quipment)\\b)',
                                   '(\\bfactor(y|ies)\\b)',
                                   '(\\bf(i(nancial|rm)|e(dera(l|tions?)|llowships?))\\b)',
                                   '(\\bf(lorists?|oundation|urniture)\\b)',
                                   '(\\bg(allery|ifts?|lobal|rill(s|ing)?)\\b)',
                                   '(\\bhair(cut(s|ters?)?)?\\b)',
                                   '(\\bhea(lth(care)?|ting)\\b)',
                                   '(\\bh(istorical|o(tels?|using))\\b)',
                                   '(\\binc(\\.|orporated)?\\b)',
